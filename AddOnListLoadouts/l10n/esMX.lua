...
--[[
    TRANSLATOR NOTES FOR SPANISH - MEXICO (esMX):
    ...
    - Use Mexican Spanish terms vs European Spanish variants
    - Consider informal "tú" vs formal "usted" based on WoW Mexico localization
    - Maintain Spanish punctuation: ¿question? ¡exclamation!
    - Spanish text typically 15-25% longer than English - test UI layout
    - Use Mexican vocabulary preferences (computadora vs ordenador)
